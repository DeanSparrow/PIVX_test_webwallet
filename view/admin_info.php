...
<div style="padding-top:15px" class="container">
   <div class="panel panel-default">
      <div class="panel-body">
         <a href="?a=home" class="btn btn-success">Go back to admin home</a>
         <br /><br />
         <?php
         ...
         ?>
            ...
            <form action="<?php echo '?a=info&i=' . $info['id']; ?>" method="POST" class="clearfix" id="pwdform">
               ...
               <div class="col-md-2"><button type="submit" class="btn btn-success">Change password</button></div>
            </form>
            <p id="pwdmsg"></p>
            <br />
            <p>Withdraw funds:</p>
            <form action="<?php echo '?a=info&i=' . $info['id']; ?>" method="POST" class="clearfix" id="withdrawform">
               ...
               <div class="col-md-2"><button type="submit" class="btn btn-success">Withdraw</button></div>
            </form>
            <p id="withdrawmsg"></p>
            <br />
            <p>Addresses:</p>
            <form action="<?php echo '?a=info&i=' . $info['id']; ?>" method="POST" id="newaddressform">
               ...
               <button type="submit" class="btn btn-success">Get a new address</button>
            </form>
